# Migration `20191120144633-cat`

This migration has been generated by Julius de Bruijn at 11/20/2019, 2:46:33 PM.
...
You can use a specific Photon built for this migration (20191120144633-cat)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191120144633-cat'
